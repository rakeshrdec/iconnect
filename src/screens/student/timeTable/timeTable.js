...
const TimeTable = ({ navigation }) => {
    ...
    async function getTimeTables() {
        const response = await fetch(apiUrl +`/user/getAllActiveUsers?sessionYear=${session.id}&userType=3`);
        ...
        const classResponse = await fetch(apiUrl +`/class/getClassById?classId=${selectedStudent.classId}`);
        ...
        const subjectResponse = await fetch(apiUrl +`/subject/getAllSubjects`);
        ...
        const timeTableResponse = await fetch(apiUrl +`/timeTable/getAllTimeTable`);
        ...
        const classTimeTableResponse = await fetch(apiUrl +`/class/getAllClassTimetableDetails?sectionId=${selectedStudent.sectionId}`);
